...
function get_geocode($address){
    ...
    $url ="https://maps.googleapis.com/maps/api/geocode/json?address={$address}&key=AIzaSyB28bbR0I2DsOa4gUeD8kT2azQe-xUJvrA";
...
echo json_encode(get_geocode($hotel_name));
?>
